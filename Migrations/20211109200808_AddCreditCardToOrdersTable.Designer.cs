...
namespace JYTGameStore.Migrations
{
    ...
    [Migration("20211109200808_AddCreditCardToOrdersTable")]
    partial class AddCreditCardToOrdersTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JYTGameStore.Models.CreditCard", b =>
                {
            ...
            modelBuilder.Entity("JYTGameStore.Models.GameReview", b =>
                {
                    ...
                    b.Property<string>("gameReviewDescription")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("JYTGameStore.Models.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("JYTGameStore.Models.Orders", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("IsPhysicalShipping")
                        .HasMaxLength(1)
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("JYTGameStore.Models.RegisterEvent", b =>
                {
            ...
            modelBuilder.Entity("JYTGameStore.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("JYTGameStore.Models.Orders", "Orders")
                        .WithMany()
            ...
            modelBuilder.Entity("JYTGameStore.Models.Orders", b =>
                {
                    b.HasOne("JYTGameStore.Models.CreditCard", "CreditCard")
                        .WithMany()
            ...
            modelBuilder.Entity("JYTGameStore.Models.RegisterEvent", b =>
                {
                    b.HasOne("JYTGameStore.Models.Event", "Event")
                        .WithMany()
